...
interface IFacebookPublishPrivacy {
    value?: string; //enum{ 'EVERYONE', 'ALL_FRIENDS', 'FRIENDS_OF_FRIENDS', 'CUSTOM', 'SELF' };
    allow?: string[];
    deny?: string[];
}

interface IFacebookPublish {
    link?: string;
    name?: string;
    caption?: string;
    description?: string;
    ...
    actions?: any[];
    place?: string;
    privacy?: IFacebookPublishPrivacy;
    access_token?: string;
}
...
// api(/me/albums)
interface IFacebookAPIPhotoAlbumForm {
    message?: string;
    name?: string;
    pageId?: string;
    eventId?: string;
    changePhotoEvent?: boolean;
    access_token?: string;
}

// api(/me/photos)
interface IFacebookAPIPhoto {
    url?: string;
    message?: string;
    no_story?: boolean;
    place?: string;
...
// api(/page/events)
interface IFacebookAPIPageEvent {
    access_token?: string;
    name?: string;
    start_time?: string;
    end_time?: string;
    ...
    location_id?: string;
    /**
    * privacy_type: enum{'OPEN', 'SECRET', 'FRIENDS'}
    */
    privacy_type?: string;
}

// api(/me/events)
interface IFacebookAPIEvent {
    access_token?: string;
    name?: string;
    start_time?: string;
    end_time?: string;
...
interface IFacebookAPIEventResponseData {
    id?: string;
    description?: string;
    end_time?: string;
    location?: string;
    name?: string;
    owner?: IFacebookAPIUserResponse;
    picture?: string;
...
interface IFacebook {
    ...
    api(params: Object, cb: (response?: any) => void): void;
	...
	getAuthResponse(cb?:(response:IFacebookAuthResponse) => void ): any;
